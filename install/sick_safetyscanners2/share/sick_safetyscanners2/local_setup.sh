...
: ${AMENT_CURRENT_PREFIX:="/home/nrc/Manual_Control_F3/install/sick_safetyscanners2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sick_safetyscanners2/environment/library_path.sh"
