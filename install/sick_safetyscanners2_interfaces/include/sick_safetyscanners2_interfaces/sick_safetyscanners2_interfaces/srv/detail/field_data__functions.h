...
#ifndef SICK_SAFETYSCANNERS2_INTERFACES__SRV__DETAIL__FIELD_DATA__FUNCTIONS_H_
#define SICK_SAFETYSCANNERS2_INTERFACES__SRV__DETAIL__FIELD_DATA__FUNCTIONS_H_
...
/// Initialize srv/FieldData message.
/**
...
/// Finalize srv/FieldData message.
/**
...
/// Create srv/FieldData message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Request__init().
...
/// Destroy srv/FieldData message.
/**
 * It calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Request__fini()
...
/// Check for srv/FieldData message equality.
/**
...
/// Initialize array of srv/FieldData messages.
/**
...
/// Finalize array of srv/FieldData messages.
/**
 * It calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Request__fini()
...
/// Create array of srv/FieldData messages.
/**
 * It allocates the memory for the array and calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FieldData messages.
/**
 * It calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FieldData message array equality.
/**
...
/// Copy an array of srv/FieldData messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sick_safetyscanners2_interfaces
...
/**
 * It calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sick_safetyscanners2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sick_safetyscanners2_interfaces
...
/**
 * It calls
 * sick_safetyscanners2_interfaces__srv__FieldData_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SICK_SAFETYSCANNERS2_INTERFACES__SRV__DETAIL__FIELD_DATA__FUNCTIONS_H_
