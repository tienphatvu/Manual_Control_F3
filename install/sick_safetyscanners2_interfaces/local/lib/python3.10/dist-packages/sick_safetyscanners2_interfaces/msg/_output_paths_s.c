...
bool sick_safetyscanners2_interfaces__msg__output_paths__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sick_safetyscanners2_interfaces.msg._output_paths.OutputPaths", full_classname_dest, 61) == 0);
  }
  sick_safetyscanners2_interfaces__msg__OutputPaths * ros_message = _ros_message;
  {  // status
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      bool * dest = ros_message->status.data;
  ...
  {  // active_monitoring_case
    PyObject * field = PyObject_GetAttrString(_pymsg, "active_monitoring_case");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->active_monitoring_case = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of OutputPaths */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sick_safetyscanners2_interfaces.msg._output_paths");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OutputPaths");
  ...
  {  // status
    ...
    bool * src = ros_message->status.data;
  ...
  {  // active_monitoring_case
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->active_monitoring_case);
    {
      int rc = PyObject_SetAttrString(_pymessage, "active_monitoring_case", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
