...
static const _Field_type_support_symbol_names_t _Field_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sick_safetyscanners2_interfaces, msg, Field)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sick_safetyscanners2_interfaces, msg, Field)),
  }
};
...
{
  return &::sick_safetyscanners2_interfaces::msg::rosidl_typesupport_cpp::Field_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sick_safetyscanners2_interfaces, msg, Field)() {
  return get_message_type_support_handle<sick_safetyscanners2_interfaces::msg::Field>();
}
