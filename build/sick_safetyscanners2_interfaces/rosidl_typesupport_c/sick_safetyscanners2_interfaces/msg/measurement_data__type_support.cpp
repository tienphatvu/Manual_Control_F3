...
static const _MeasurementData_type_support_symbol_names_t _MeasurementData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sick_safetyscanners2_interfaces, msg, MeasurementData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sick_safetyscanners2_interfaces, msg, MeasurementData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sick_safetyscanners2_interfaces, msg, MeasurementData)() {
  return &::sick_safetyscanners2_interfaces::msg::rosidl_typesupport_c::MeasurementData_message_type_support_handle;
}
