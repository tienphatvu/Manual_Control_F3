...
#include "sick_safetyscanners2_interfaces/msg/detail/measurement_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const sick_safetyscanners2_interfaces::msg::ScanPoint &,
...
cdr_serialize(
  const sick_safetyscanners2_interfaces::msg::MeasurementData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sick_safetyscanners2_interfaces::msg::MeasurementData & ros_message)
{
  // Member: number_of_beams
  cdr >> ros_message.number_of_beams;
  ...
  // Member: scan_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.scan_points[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: scan_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sick_safetyscanners2_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_ScanPoint(
  ...
  if (is_plain) {
    ...
    using DataType = sick_safetyscanners2_interfaces::msg::MeasurementData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sick_safetyscanners2_interfaces::msg::MeasurementData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sick_safetyscanners2_interfaces::msg::MeasurementData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MeasurementData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sick_safetyscanners2_interfaces::msg::MeasurementData *>(
...
static size_t _MeasurementData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MeasurementData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MeasurementData__callbacks = {
...
static rosidl_message_type_support_t _MeasurementData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MeasurementData__callbacks,
...
{
  return &sick_safetyscanners2_interfaces::msg::typesupport_fastrtps_cpp::_MeasurementData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sick_safetyscanners2_interfaces, msg, MeasurementData)() {
  return &sick_safetyscanners2_interfaces::msg::typesupport_fastrtps_cpp::_MeasurementData__handle;
}
