...
PICK_DROP_FORWARD_OFFSET_M = 0.3
        ...
        "nodes": [
            {
                ...
                "nodePosition": {
                    ...
                    "y": float(pose.y),
                    "theta": float(pose.theta),
                    "mapDescription": str(pose.map_description),
                    "mapId": str(pose.map_id),
                    "allowedDeviationXy": 1.5,
                    "allowedDeviationTheta": math.pi,
                },
            }
        ],
    }
