...
class RobotDashboard(ttk.Window):
    ...
    def _build_ui(self):
        ...
        self.btn_detect = ttk.Button(
            action_row,
            text="🎯 DETECT",
            command=lambda: self._run_cmd(self.detect_cmd),
            bootstyle="primary",
            width=12,
        )
        self.btn_detect.pack(side="left", padx=(10, 0), ipady=5)
    ...
    def _set_controls_state(self, enabled: bool):
        ...
        for b in [
            ...
            self.btn_stop, self.btn_drop, self.btn_pick, self.btn_detect, self.btn_goto, self.btn_use_pose
        ]:
    ...
    def _set_manual_controls_temporarily(self, enabled: bool):
        ...
        for b in [
            ...
            self.btn_front, self.btn_back, self.btn_left, self.btn_right,
            self.btn_cw, self.btn_ccw,
            self.btn_drop, self.btn_pick, self.btn_detect, self.btn_goto, self.btn_use_pose
        ]:
            b.config(state=state)
